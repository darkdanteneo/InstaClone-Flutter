...
class Comments extends StatefulWidget {
  ...
  CommentsState createState() =>
      CommentsState(postId: this.postId, postOwnerId: this.postOwnerId, mediaUrl: this.mediaUrl);
}
...
class CommentsState extends State<Comments> {
  ...
  buildComments() {
    return StreamBuilder(
      stream: commentsRef.doc(postId).collection('comment').orderBy('timeStamp', descending: true).snapshots(),
